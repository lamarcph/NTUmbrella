...
| **[Nerberus](Nerberus/)** | Triple-band saturation and texture processor — independent low/mid/high dynamics and grit, plus filter, crush/decimation, transient shaping, ring modulation, and CV control. |
...
```bash
cd PolyLofi   # or Oneiroi, Nerberus, NoiseBouquet, LofiOsc
make
```
