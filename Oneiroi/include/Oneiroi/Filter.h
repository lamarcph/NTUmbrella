...
private:
    ...
    void SetFreq(float value)
    {
       ...
       //float cutoff = value ;// Clamp(MapLog(value, 0.f, 1.f, 10.f, 22000.f), 10.f, 22000.f); REVERT
...
public:
    ...
    void process(AudioBuffer &input, AudioBuffer &output)
    {
        ...
        //float c = patchCtrls_->filterCutoff; // Modulate(patchCtrls_->filterCutoff, patchCtrls_->filterCutoffModAmount, patchState_->modValue, patchCtrls_->filterCutoffCvAmount, patchCvs_->filterCutoff, -1.f, 1.f, patchState_->modAttenuverters, patchState_->cvAttenuverters); REVERT
